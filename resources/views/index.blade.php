        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{asset($other_post->featured)}}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{asset($other_post->featured)}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="15_blog_details.html">{{$other_post->title}}</a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="post__date">
                                            ...
                                            <time class="published" datetime="2016-04-17 12:00:00">
                                                {{$other_post->created_at->toFormattedDateString()}}
                                            </time>
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="#">{{$other_post->category->name}}</a>
                                        </span>
